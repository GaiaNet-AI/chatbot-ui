...
import {IconCheck, IconCopy, IconEdit, IconRefresh, IconTrash,} from '@tabler/icons-react';
...
export const ChatMessage: FC<Props> = memo(
    ({message, maxImg, messageIndex, onRegenerate, onEdit}) => {
        ...
        return (
            <div
                className={`group md:px-4 bg-fontLight text-gray-800 `}
                style={{overflowWrap: 'anywhere'}}
            >
                <div className="relative m-auto flex p-4 text-base md:max-w-2xl md:gap-6 lg:max-w-5xl lg:px-0">
                    <div className="mx-2 flex w-full bg-fontLight sm:mx-4 gap-6">
                        {message.role === 'assistant' ? (
                            ...
                            <img
                                style={{width: '32px', height: '32px', borderRadius: '50%'}}
                                src={'https://www.gaianet.ai/icons/icon-user.png'}
                                alt=""
                            />
                        )}
                      ...
                      />
                                        ...
                                        <div className="prose whitespace-pre-wrap flex-1 text-[#696868]">
