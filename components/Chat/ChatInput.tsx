...
export const ChatInput = ({
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full  pt-6 bg-white ">
      <input
        type="file"
        accept="image/*"
        ...
        id="upload-button"
      />
      <div className="lg:mx-auto lg:max-w-3xl mx-2 md:mx-4  ">
        <div
          className={
            'flex justify-start' + (imageSrcList.length > 0 ? ' mt-4' : '')
          }
        >
          <div className="text-black flex items-center p-2 mx-2 sm:mx-4 w-full rounded-t-md bg-white border-black/10  border-t border-x">
            <button
              title="upload image file"
              disabled={maxImg === 0}
              className={
                'p-2 mr-2 bg-[#F7F7F7] rounded-lg' +
                (maxImg === 0 ? ' cursor-not-allowed' : '')
              }
              onClick={() => {
            ...
            {urlInputShow ? (
              <>
                <input
                  ...
                  className="px-2 h-full bg-[#ffffff] border-l border-t border-b outline-none rounded-l-lg"
                />
                <button
                  title="upload"
                  className="p-2 bg-[#F7F7F7]  rounded-r-lg"
                  onClick={uploadInput}
                >
            ...
            <div className={'ml-4 ' + (maxImg === 0 ? 'block' : 'hidden')}>
              For Llava series models, please submit an image URL for processing
              first.
            </div>
          </div>
        </div>
      ...
      <div className="stretch mx-2 flex flex-row gap-3 last:mb-2 md:mx-4 md:last:mb-6 lg:mx-auto lg:max-w-3xl">
        ...
        <div className="relative mx-2 flex w-full flex-grow flex-col rounded-b-md border  bg-white sm:mx-4">
          {/*<button*/}
          {/*  className="absolute left-2 top-2 rounded-sm p-1 text-neutral-800 opacity-60 hover:bg-neutral-200 hover:text-neutral-900 dark:bg-opacity-50 dark:text-neutral-100 dark:hover:text-neutral-200"*/}
          {/*  // onClick={() => setShowPluginSelect(!showPluginSelect)}*/}
          {/*  // onKeyDown={(e) => {}}*/}
          {/*>*/}
          <div className="absolute left-2 top-2 rounded-sm p-1 ">
            {/*{plugin ? <IconBrandGoogle size={20} /> : <IconBolt size={20} />}*/}
            <IconBolt size={20} color="#989898" />
          </div>
          {/*</button>*/}
          ...
          <textarea
            ref={textareaRef}
            className="m-0 w-full resize-none border-0 rounded-r-lg rounded-l-lg outline-none bg-white p-0 py-2  pr-20 md:pr-8 pl-10 text-black md:py-3 md:pl-10 h-[56px] md:h-auto"
            style={{
              resize: 'none',
          ...
          >
            {messageIsStreaming ? (
              <div className="h-4 w-4 animate-spin rounded-full border-t-2 border-neutral-800  "></div>
            ) : (
              <>
                <img
