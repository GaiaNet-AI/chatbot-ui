    ...
    <div className="relative flex-1 overflow-hidden bg-white">
      {!(apiKey || api) ? (
        ...
        <>
          ...
          >
            <div className="sticky z-10 top-0 flex w-screen items-center justify-end gap-3 h-[84px] bg-white border-b border-[rgba(0,0,0,0.15)] pl-4 md:pl-0 pr-4 md:pr-5">
